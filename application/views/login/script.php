...
$(document).ready(function() {
    $('#tambahForm').submit(function(e) {
        ...
        $.ajax({
            url: "<?php echo base_url('index.php/datalogin/tambah'); ?>",
            type: 'post',
            data: formData,
...
<script>
    $(document).ready(function() {
        ...
        $('#hapusButton').click(function() {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php/datalogin/hapus'); ?>",
                type: 'POST',
                data: {
                    id: idToDelete
                },
...
<script>
    $(document).ready(function() {
        ...
        $('.edit').click(function() {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php/datalogin/get_data_by_id'); ?>",
                type: 'POST',
                data: {
                    id: idToEdit
                },
        ...
        $('#editForm').submit(function(e) {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php/datalogin/edit_data'); ?>",
                type: 'POST',
                data: formData,
                dataType: 'json',
                success: function(response) {
